/*
	...
	Filename:     FGKZ.C	(Encoder/Decoder)
	Written by:   Gerald R. Tamayo
	Date:         2005/2023, September 16, 2024
	
	To compile:   g++ -O3 fgkz.c gtbitio2.c huf2.c -s -o fgkz
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void decompress_fgk( void )
{
	...
	*/
	...
	init_get_buffer();
	nbytes_read += (sizeof(file_stamp)+1);  /* plus first symbol */
